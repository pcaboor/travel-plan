...
import com.travelplan.payment.service.NotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleProvider(ProviderException ex) {
        if (ex.isDisabled()) {
            return error(HttpStatus.SERVICE_UNAVAILABLE, "provider_disabled", ex.getMessage());
        }
        return error(HttpStatus.BAD_GATEWAY, "provider_error", ex.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        Map<String, Object> body = new LinkedHashMap<>(baseBody(HttpStatus.BAD_REQUEST,
